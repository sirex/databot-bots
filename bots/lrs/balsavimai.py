    ...
    'tasks': [
        ...
        select(this.key, {
            ...
            'klausimai': ['xpath://b/a[contains(@class, "link") and text()="dokumento tekstas"]', {
                'pavadinimas': select('xpath:./../preceding-sibling::b/a[contains(@class, "link")]/text()'),
                'rūšis': select('xpath:./../preceding-sibling::b[contains(a/@class, "link")]/following-sibling::text()[1]'),
                'klausimo-nuoroda': select('xpath:./../preceding-sibling::b/a[contains(@class, "link")]/@href'),
            ...
            'rezultatai': ['.sale-group-title xpath:text()[.="Individualūs balsavimo  rezultatai"]/../following-sibling::table/tr[count(td)=5]', {
                ...
                'p_asm_id': select('td[1] > a@href').urlparse().query.p_asm_id.cast(int),
